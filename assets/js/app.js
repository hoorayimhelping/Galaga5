...
/***/ function(module, exports, __webpack_require__) {
	...
	var _keypress = __webpack_require__(4);
	...
	var Galaga = function Galaga() {
	  ...
	  this.loadAssets = function () {
	    _this.keyboardListener = new _keypress2.default.Listener(window);
	  };
	  ...
	  this.update = function (dt) {
	    ...
	    _this.render(dt);
	    _this.previousGameState = Object.assign({}, _this.gameState);
	  };
	  ...
	  this.bindKeyboard = function () {
	    _this.keyboardListener.simple_combo("escape", _this.pause);
	  };
	  ...
	  this.previousGameState = _extends({}, this.gameState);
	};
...
/***/ function(module, exports) {
	...
	var Control = function Control() {
	  ...
	  this.clearPressedKeys = function () {
	    return Object.keys(_this.pressedKeys).map(function (key) {
	      return _this.pressedKeys[key] = false;
	    });
	  };
